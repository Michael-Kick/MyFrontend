...
export const ResumeElement = (props: ResumeElementProps) => {
    return (
        <div className="mb-16 md:mb-32">
            <h1 className='font-bold text-3xl sm:text-4xl md:text-4xl lg:text-5xl mb-8 md:mb-16 w-full text-center md:text-left md:pl-[15%]'>{props.heading}</h1>
            <div className="w-full md:w-[90%] lg:w-[80%] xl:w-[75%] max-w-5xl mx-auto relative">
